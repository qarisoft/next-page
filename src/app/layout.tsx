  ...
  return (
    <html suppressHydrationWarning lang="ar" dir="rtl" >
      ...
      >
          ...
          <Link   href={'https://wa.me/966533307024'} className="fixed bg-white  bottom-0 z-10 ssssssss h-10 w-10 rounded-full m-3">
              <svg fill="#2dc322"  className={'-m-0.5 '} version="1.1" id="Layer_1"
                   xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308 308"
                   ><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier"> <g id="XMLID_468_"> <path id="XMLID_469_"
